...
const ActionButton: React.FC<ActionButtonProps> = ({
  ...
  <button
    onClick={onClick}
    disabled={disabled}
    className={`pixel-button relative flex min-h-[4.95rem] w-full flex-col items-center justify-center gap-1 overflow-hidden border-pixel-bg-deep/80 bg-linear-to-br p-1.5 shadow-[0_5px_0_#05030a,inset_0_0_0_2px_rgba(255,255,255,0.16)] hover:scale-[1.015] disabled:hover:scale-100 max-[380px]:min-h-[4.55rem] max-[380px]:p-1.5 ${gradient}`}>
    ...
    <span className="grid h-8 w-8 place-items-center text-white max-[380px]:h-7 max-[380px]:w-7">
      <Icon
        size={25}
        strokeWidth={2.2}
        className="drop-shadow-[0_2px_0_rgba(0,0,0,0.55)] max-[380px]:h-5 max-[380px]:w-5"
      />
    </span>
